...
namespace Liminal.SDK.EventManager.Examples
{
    public class LiminalSdkActionEventExample : MonoBehaviour
    {
        ...
        public class PlatformExample1
        {
            public void Start()
            {
                var goToLoginEventData = new LiminalSdkActionEventData("GoToLoginEvent", GoToLogin, 2);
        ...
        public class ExperienceExample1 : MonoBehaviour
        {
            public void DuringExperience()
            {
                ...
                StartCoroutine(LiminalSdkEventManager.TriggerAllExperienceActionEventsWithIdRoutine("GoToLoginEvent"));
            }
        }
