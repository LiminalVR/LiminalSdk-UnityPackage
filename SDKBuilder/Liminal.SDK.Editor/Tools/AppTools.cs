...
namespace Liminal.SDK.Tools
{
    ...
    public static class AppTools
    {
        ...
        /// </summary>
        [MenuItem("Liminal/Create or Update App Manifest")]
        public static void CreateAppManifest()
        {
            var asset = AssetDatabase.LoadAssetAtPath<TextAsset>(AppManifest.Path);
        ...
        /// </summary>
        [MenuItem("Liminal/Setup App Scene")]
